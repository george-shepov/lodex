...
function sharedNav() {
  return `<div class="utility-bar"><span>Northeast Ohio · Residential &amp; commercial</span><a href="tel:+12162474724">Call LODEX · (216) 247-4724</a></div>
...
function renderHome(route) {
  ...
  <section id="sms-opt-in" class="service-next"><div class="page-width"><p class="eyebrow">LODEX text updates</p><h2>Text START to (216) 247-4724 to opt in.</h2><p>Receive service-related SMS/MMS from LODEX about inquiries, estimates, appointments, scheduling, and project updates. Message frequency varies. Message and data rates may apply. Reply STOP to opt out or HELP for assistance. Consent is optional and is not a condition of purchase.</p><div class="hero-actions"><a class="primary-button" href="sms:+12162474724">Text LODEX <span>↗</span></a><a class="phone-link" href="/privacy">Privacy Policy</a><a class="phone-link" href="/terms">Terms &amp; Conditions</a></div></div></section>`
}

function renderService(route) {
  return `<section class="service-hero page-width"><nav class="seo-breadcrumb" aria-label="Breadcrumb"><a href="/">Home</a><span>›</span><a href="/#services">Services</a><span>›</span><span aria-current="page">${escapeHtml(route.h1)}</span></nav><div class="service-hero-grid"><div><p class="eyebrow">LODEX services</p><h1>${escapeHtml(route.h1)}</h1><p class="service-lede">${escapeHtml(route.intro)}</p><div class="hero-actions"><a class="primary-button" href="/#intake">Start this project <span>↗</span></a><a class="phone-link" href="tel:+12162474724">Call (216) 247-4724</a></div></div><div class="service-hero-media"><img class="service-reel-image" src="${route.image}" alt="${escapeHtml(route.h1)}" width="1254" height="1254" /></div></div></section><section class="service-details page-width"><div><p class="section-kicker">Included services</p><ul>${route.includes.map(item => `<li>${escapeHtml(item)}</li>`).join('')}</ul></div><div><p class="section-kicker">A good fit when</p><ul>${route.useCases.map(item => `<li>${escapeHtml(item)}</li>`).join('')}</ul></div></section><section class="service-next"><div class="page-width"><p class="eyebrow">Start with the real details</p><h2>Photo, video, or a few plain words is enough to begin.</h2><a class="primary-button" href="/#intake">Tell us about it <span>↗</span></a></div></section>`
}
