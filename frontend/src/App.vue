...
<template>
  <main>
    ...
    <nav class="site-nav">
      <a class="brand" href="#top" aria-label="LODEX home"><img class="brand-logo" src="/lodex-logo.png" alt="LODEX Residential & Commercial Services" /></a>
